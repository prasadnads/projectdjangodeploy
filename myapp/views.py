...
# Class based view above products view(listview)      
...
def product_detail(request,id):
    product = Product.objects.get(id=id)                      #single product that's y product
    context = {
        'product':product
    }
    return render(request, 'myapp/detail.html', context)

#Class based view for above product details view[Detail View]
...
#Class based view for creating a product(CreatView)
...
#     order.strip_payment_intent = checkout_session['payment_intent']
